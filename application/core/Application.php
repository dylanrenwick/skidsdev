...
class Application
{
    ...
    public function __construct()
    {
        ...
        // example: if controller would be "car", then this line would translate into: $this->controller = new car();
        ...
        if (!empty($requestRoute)) {
            ...
            // if no parameters are given, just call the method without parameters, like $this->controller->index();
